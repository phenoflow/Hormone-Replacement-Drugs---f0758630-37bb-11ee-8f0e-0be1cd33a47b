...
(async () => {
  ...
  await fs.writeFile("hormone-replacement-drugs-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("hormone-replacement-drugs-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
